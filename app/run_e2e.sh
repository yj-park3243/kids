...
SIM_DEVICE_A="$(resolve_sim "${SIM_DEVICE_A:-447803FE-BD81-4025-A533-BB4099269D6E}" SIM_DEVICE_A)" || exit 1                                    # iPhone 17 Pro
SIM_DEVICE_B="$(resolve_sim "${SIM_DEVICE_B:-72277065-7CE6-4908-82AE-3C6DBE39FF4C}" SIM_DEVICE_B "$SIM_DEVICE_A")" || exit 1                    # iPhone 17
SIM_DEVICE_C="$(resolve_sim "${SIM_DEVICE_C:-4F6D9DBC-731E-4203-9310-4311ABE8A9E5}" SIM_DEVICE_C "$SIM_DEVICE_A" "$SIM_DEVICE_B")" || exit 1   # match
